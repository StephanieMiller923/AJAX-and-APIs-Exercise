...
// 4b
const fullURL = `https://api.tvmaze.com/shows/${id}/episodebynumber?season=${season}&number=${number}`;
...
async function tvMazeFunc(){
    ...
    try {
    // 4c & 4d
const mando = await axios.get(`https://api.tvmaze.com/shows/${id}/episodebynumber?season=${season}&number=${number}`);
//OR
//axios.get(fullURL);
// 4e
